...
begin
  ...
  enable_archive <= convert3_dout_net;
  select_source <= register1_q_net_x2;
  tx_high <= slice11_y_net;
...
begin
  ...
  port map (
    ...
    stoptoneblong => register1_q_net_x14,
...
architecture structural of n3_te0722 is 
  ...
  attribute core_generation_info of structural : architecture is "n3_te0722,sysgen_core_2014_4,{,compilation=IP Catalog,block_icon_display=Default,family=zynq,part=xc7z010,speed=-1,package=clg225,synthesis_language=vhdl,hdl_library=xil_defaultlib,synthesis_strategy=Vivado Synthesis Defaults,implementation_strategy=Vivado Implementation Defaults,clock_loc=,testbench=0,interface_doc=1,ce_clr=0,clock_period=30,system_simulink_period=2.03451e-08,simulation_time=0.0001,accum=14,addsub=29,assert=10,bitbasher=9,blackbox2=8,cmult=1,concat=56,constant=141,convert=110,counter=24,delay=105,dpram=9,fifo=6,inv=60,logical=165,mult=3,mux=19,register=125,reinterpret=22,relational=99,slice=171,sprom=4,}";
