...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  monostable_x1 : entity xil_defaultlib.n3z_tonetest_monostable_x5 
  port map (
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  monostable_x1 : entity xil_defaultlib.n3z_tonetest_monostable_x6 
  port map (
    in1 => slice2_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  monostable_x1 : entity xil_defaultlib.n3z_tonetest_monostable_x4 
  port map (
    in1 => slice2_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
begin
  ...
  stoptonea <= register1_q_net_x6;
  stoptonealong <= register1_q_net_x5;
  stoptoneb <= register1_q_net;
  stoptoneblong <= register1_q_net_x0;
  ...
  subsystem17_x0 : entity xil_defaultlib.n3z_tonetest_subsystem17 
  port map (
    data => picoblaze6_out_port_net,
    portid => picoblaze6_port_id_net,
    write => convert3_dout_net_x0,
  ...
  subsystem4_x0 : entity xil_defaultlib.n3z_tonetest_subsystem4_x2 
  port map (
    data => picoblaze6_out_port_net,
    portid => picoblaze6_port_id_net,
    write => convert3_dout_net_x0,
...
entity n3z_tonetest_dsprocessor1 is
  port (
    ...
    addrram : in std_logic_vector( 11-1 downto 0 );
...
begin
  ...
  user2dspfifofull <= fifo_full_net;
  agcvalue <= slice8_y_net;
  btaudioout <= concat_y_net_x2;
  speakeron <= convert_dout_net_x0;
  starttonea <= slice10_y_net;
  starttonealong <= slice9_y_net_x0;
  starttoneb <= slice12_y_net;
  starttoneblong <= slice13_y_net;
...
begin
  ...
  monostable_x1 : entity xil_defaultlib.n3z_tonetest_monostable_x9 
  port map (
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  monostable_x1 : entity xil_defaultlib.n3z_tonetest_monostable_x8 
  port map (
...
begin
  ...
  monostable_x1 : entity xil_defaultlib.n3z_tonetest_monostable_x7 
  port map (
    in1 => slice_y_net_x0,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
begin
  ...
  subsystem4_x0 : entity xil_defaultlib.n3z_tonetest_subsystem4_x1 
  port map (
    data => picoblaze6_out_port_net,
    portid => picoblaze6_port_id_net,
    write => convert3_dout_net,
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  monostable_x1 : entity xil_defaultlib.n3z_tonetest_monostable_x1 
  port map (
    in1 => slice2_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  monostable_x1 : entity xil_defaultlib.n3z_tonetest_monostable_x2 
  port map (
    in1 => slice2_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
begin
  ...
  monostable_x1 : entity xil_defaultlib.n3z_tonetest_monostable 
  port map (
    in1 => logical1_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  monostable_x1 : entity xil_defaultlib.n3z_tonetest_monostable_x0 
  port map (
    in1 => convert2_dout_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
begin
  ...
  dodemod <= logical_y_net_x6;
  picoblaze6_out_port_net <= data;
  picoblaze6_port_id_net <= portid;
  convert3_dout_net <= write;
  starttones <= concat1_y_net;
  stoptones <= concat2_y_net;
  strobetones <= logical_y_net_x8;
  clk_net <= clk_1;
  ce_net <= ce_1;
  ...
  port map (
    ...
    in2 => register1_q_net_x1,
    in3 => register1_q_net_x10,
    y => concat1_y_net
  );
...
begin
  ...
  newtdcmd2user <= logical_y_net_x3;
  register_q_net <= filterredsignal;
  concat_y_net_x0 <= instruction;
  slice_y_net <= strobe;
  resetpicos_net <= rstpicos;
  ...
  generic map (
    c_address_width => 8,
    c_width => 16,
    core_name0 => "n3z_tonetest_blk_mem_gen_v8_3_i8",
    latency => 1
  )
  port map (
    en => "1",
...
begin
  ...
  subsystem4_x0 : entity xil_defaultlib.n3z_tonetest_subsystem4_x0 
  port map (
    data => picoblaze1_out_port_net,
    portid => picoblaze1_port_id_net,
    write => convert1_dout_net_x0,
...
begin
  ...
  usertxdata <= register1_q_net_x9;
  armdataack <= logical_y_net_x5;
  resetpicos_net <= rstpicos;
  dual_port_ram1_doutb_net_x0 <= kpramrdbk;
  ...
  ackfifokp <= logical2_y_net;
  ackfifotd <= logical3_y_net;
  attenuator <= register1_q_net_x5;
  keypadcmd <= register1_q_net_x2;
  loranblankselect <= slice9_y_net_x0;
  newkeypadcmd <= logical_y_net_x2;
  ramdata <= concat4_y_net;
  writedsp_ram <= relational6_op_net;
  writekp_ram <= relational8_op_net;
  clk_net <= clk_1;
  ...
  generic map (
    ...
    c_width_a => 18,
    c_width_b => 18,
    core_name0 => "n3z_tonetest_blk_mem_gen_v8_3_i9",
    latency => 1
  )
  port map (
    enb => "1",
  ...
  relational : entity xil_defaultlib.sysgen_relational_5a10ff77f2 
  port map (
    clr => '0',
    a => convert4_dout_net,
    b => userpicoinstruction_net,
    clk => clk_net,
    ce => ce_net,
    op => relational_op_net
  );
...
architecture structural of n3z_tonetest_struct is 
  ...
  signal register_q_net : std_logic_vector( 18-1 downto 0 );
  signal concat1_y_net_x0 : std_logic_vector( 11-1 downto 0 );
  signal concat_y_net_x2 : std_logic_vector( 18-1 downto 0 );
  signal register1_q_net_x0 : std_logic_vector( 8-1 downto 0 );
  signal logical_y_net_x1 : std_logic_vector( 1-1 downto 0 );
  signal reinterpret_output_port_net : std_logic_vector( 16-1 downto 0 );
  signal dual_port_ram1_doutb_net_x0 : std_logic_vector( 16-1 downto 0 );
  ...
  signal register1_q_net_x11 : std_logic_vector( 8-1 downto 0 );
  signal concat1_y_net_x1 : std_logic_vector( 8-1 downto 0 );
  ...
  signal concat4_y_net_x1 : std_logic_vector( 32-1 downto 0 );
...
begin
  ...
  pl2ps_tdata <= register1_q_net_x1;
  ...
  port map (
    ...
    clk_1 => clk_net,
    ce_1 => ce_net,
    audioout => register1_q_net_x19,
    amp => register1_q_net_x17,
    ...
    speakeron => convert_dout_net_x0,
    starttonea => slice10_y_net_x0,
    starttonealong => slice9_y_net_x5,
    starttoneb => slice12_y_net_x0,
    starttoneblong => slice13_y_net,
    stoptonea => register1_q_net_x13,
    stoptonealong => register1_q_net_x14,
    stoptoneb => register1_q_net_x15,
    stoptoneblong => register1_q_net_x16
  );
  ...
  port map (
    ...
    stoptonealong => register1_q_net_x14,
    stoptoneb => register1_q_net_x15,
    instruction => concat_y_net_x2,
    stoptoneblong => register1_q_net_x16,
    newkeypadcmd => logical_y_net_x3,
    keypadcmd => register1_q_net_x4,
    rstpicos => resetpicos_net,
    ...
    ce_1 => ce_net,
    data2archive => concat4_y_net_x0,
    data2archive_w => logical_y_net_x11,
    lcddata => register1_q_net_x10,
    lcdctrl => slice6_y_net_x0,
    latchon => register1_q_net_x11,
    kpcmd2user => register1_q_net_x9,
    newkpcmd2user => logical_y_net_x12,
    resetpeak => logical_y_net_x10,
    kpramrdbk => dual_port_ram1_doutb_net,
    rxfreq => concat2_y_net_x1,
    txfreq => addsub_s_net,
    kppicoaddress => slice9_y_net_x3,
  ...
  monostable_x1 : entity xil_defaultlib.n3z_tonetest_monostable_x3 
  port map (
    in1 => convert3_dout_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  port map (
    ...
    loranpulsetrig => relational_op_net_x2,
  ...
  subsystem4_x0 : entity xil_defaultlib.n3z_tonetest_subsystem4 
  port map (
  ...
  port map (
    ...
    clk_1 => clk_net,
    ce_1 => ce_net,
    tdcmd2user => register1_q_net_x8,
    newtdcmd2user => logical_y_net_x7,
    tdpicoaddress => slice9_y_net_x2,
    starttones => concat1_y_net,
    stoptones => concat2_y_net,
    strobetones => logical_y_net_x6
  );
  ...
  port map (
    ...
    adcgain => slice_y_net_x0,
    cal => slice18_y_net,
    writeusertxdata => logical_y_net_x5,
    usertxdata => register1_q_net_x1,
  ...
  concat4 : entity xil_defaultlib.sysgen_concat_7135b596a0 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant7 : entity xil_defaultlib.sysgen_constant_727dcb5418 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  mux : entity xil_defaultlib.sysgen_mux_51a7972d3c 
  port map (
    clr => '0',
    sel => slice9_y_net,
    d0 => concat4_y_net_x1,
  ...
  port map (
    ...
    sel => slice6_y_net,
    d0 => delay1_q_net_x0,
    d1 => logical_y_net_x13,
    clk => clk_net,
    ce => ce_net,
    y => mux3_y_net
  );
  mux4 : entity xil_defaultlib.sysgen_mux_c18da20ebb 
  port map (
    clr => '0',
    sel => slice9_y_net,
  ...
  port map (
    ...
    ce => '0',
    clr => '0',
    input_port => register1_q_net_x19,
