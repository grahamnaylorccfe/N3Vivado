...
CONFIG.LAYERED_METADATA {xilinx.com:interface:datatypes:1.0 {DATA {datatype {name {attribs {resolve_type immediate dependency {} format string minimum {} maximum {}} value {}} bitwidth {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 1} bitoffset {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 0} real {fixed {fractwidth {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 0} signed {attribs {resolve_type immediate dependency {} format bool minimum {} maximum {}} value false}}}}}}} \
  ...
  # Create instance: DSPPicoInstructions, and set properties
  set DSPPicoInstructions [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.3 DSPPicoInstructions ]
  set_property -dict [ list \
CONFIG.Byte_Size {9} \
...
CONFIG.CONST_WIDTH {4} \
  ...
  # Create instance: KPPicoInstructions, and set properties
  set KPPicoInstructions [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.3 KPPicoInstructions ]
  set_property -dict [ list \
CONFIG.Byte_Size {9} \
...
CONFIG.DOUT_WIDTH {8} \
  ...
  # Create instance: TDPicoInstructions, and set properties
  set TDPicoInstructions [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.3 TDPicoInstructions ]
  set_property -dict [ list \
CONFIG.Byte_Size {9} \
...
CONFIG.use_bram_block {Stand_Alone} \
  ...
  # Create instance: UserPicoInstructions, and set properties
  set UserPicoInstructions [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.3 UserPicoInstructions ]
  set_property -dict [ list \
CONFIG.Byte_Size {9} \
...
CONFIG.DOUT_WIDTH {3} \
  ...
  connect_bd_net -net DSPPicoInstructions1_douta [get_bd_pins KPPicoInstructions/douta] [get_bd_pins n3z_tonetest_0/kppicoinstruction]
  connect_bd_net -net DSPPicoInstructions_douta [get_bd_pins DSPPicoInstructions/douta] [get_bd_pins n3z_tonetest_0/dsppicoinstruction]
  ...
  connect_bd_net -net DefaultFrequency_dout [get_bd_pins DefaultFrequency/dout] [get_bd_pins n3z_tonetest_0/defaultfreq]
  ...
  connect_bd_net -net UserPicoInstructions1_douta [get_bd_pins TDPicoInstructions/douta] [get_bd_pins n3z_tonetest_0/tdpicoinstruction]
  connect_bd_net -net UserPicoInstructions_douta [get_bd_pins UserPicoInstructions/douta] [get_bd_pins n3z_tonetest_0/userpicoinstruction]
  ...
  connect_bd_net -net axi_fifo_mm_s_0_axi_str_txd_tvalid [get_bd_pins DSPPicoInstructions/web] [get_bd_pins KPPicoInstructions/web] [get_bd_pins TDPicoInstructions/web] [get_bd_pins UserPicoInstructions/web] [get_bd_pins axi_fifo_mm_s_0/axi_str_txd_tvalid] [get_bd_pins util_vector_logic_0/Op1]
  set_property -dict [ list \
HDL_ATTRIBUTE.MARK_DEBUG {true} \
 ] [get_bd_nets axi_fifo_mm_s_0_axi_str_txd_tvalid]
  ...
  connect_bd_net -net axi_fifo_mm_s_1_axi_str_txd_tdata [get_bd_pins axi_fifo_mm_s_1/axi_str_txd_tdata] [get_bd_pins n3z_tonetest_0/ps2pl_tdata]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins DSPPicoInstructions/clka] [get_bd_pins DSPPicoInstructions/clkb] [get_bd_pins KPPicoInstructions/clka] [get_bd_pins KPPicoInstructions/clkb] [get_bd_pins TDPicoInstructions/clka] [get_bd_pins TDPicoInstructions/clkb] [get_bd_pins UserPicoInstructions/clka] [get_bd_pins UserPicoInstructions/clkb] [get_bd_pins axi_fifo_mm_s_0/s_axi_aclk] [get_bd_pins axi_fifo_mm_s_1/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/M01_ACLK] [get_bd_pins axi_mem_intercon/M02_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins n3z_tonetest_0/clk] [get_bd_pins one_clock_pulse_0/clk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_clk_wiz_0_49M/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rst_clk_wiz_0_49M/dcm_locked]
  connect_bd_net -net comparator_0_dout [get_bd_pins DSPPicoInstructions/enb] [get_bd_pins comparator_0/dout]
  connect_bd_net -net comparator_1_dout [get_bd_pins UserPicoInstructions/enb] [get_bd_pins comparator_1/dout]
  set_property -dict [ list \
HDL_ATTRIBUTE.MARK_DEBUG {true} \
 ] [get_bd_nets comparator_1_dout]
  connect_bd_net -net comparator_2_dout [get_bd_pins KPPicoInstructions/enb] [get_bd_pins comparator_2/dout]
  connect_bd_net -net comparator_3_dout [get_bd_pins TDPicoInstructions/enb] [get_bd_pins comparator_3/dout]
  ...
  connect_bd_net -net n3z_tonetest_0_dsppicoaddress [get_bd_pins DSPPicoInstructions/addra] [get_bd_pins n3z_tonetest_0/dsppicoaddress]
  connect_bd_net -net n3z_tonetest_0_keepon [get_bd_ports keepon] [get_bd_pins n3z_tonetest_0/keepon]
  connect_bd_net -net n3z_tonetest_0_kppicoaddress [get_bd_pins KPPicoInstructions/addra] [get_bd_pins n3z_tonetest_0/kppicoaddress]
  ...
  connect_bd_net -net n3z_tonetest_0_match_z [get_bd_ports match_z] [get_bd_pins n3z_tonetest_0/match_z]
  ...
  connect_bd_net -net n3z_tonetest_0_userpicoaddress [get_bd_pins UserPicoInstructions/addra] [get_bd_pins n3z_tonetest_0/userpicoaddress]
  ...
  connect_bd_net -net processing_system7_0_GPIO_O [get_bd_pins LCDctrl/Din] [get_bd_pins LCDdata/Din] [get_bd_pins processing_system7_0/GPIO_O]
  ...
  connect_bd_net -net tdpicoaddress [get_bd_pins TDPicoInstructions/addra] [get_bd_pins n3z_tonetest_0/tdpicoaddress]
  ...
  connect_bd_net -net xlconstant_2_dout [get_bd_pins n3z_tonetest_0/attenuatoron] [get_bd_pins n3z_tonetest_0/dummy] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net xlconstant_4_dout [get_bd_pins DSPPicoInstructions/ena] [get_bd_pins KPPicoInstructions/ena] [get_bd_pins TDPicoInstructions/ena] [get_bd_pins UserPicoInstructions/ena] [get_bd_pins xlconstant_4/dout]
  connect_bd_net -net xlconstant_5_dout [get_bd_pins DSPPicoInstructions/wea] [get_bd_pins KPPicoInstructions/wea] [get_bd_pins TDPicoInstructions/wea] [get_bd_pins UserPicoInstructions/wea] [get_bd_pins xlconstant_5/dout]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins DSPPicoInstructions/addrb] [get_bd_pins KPPicoInstructions/addrb] [get_bd_pins TDPicoInstructions/addrb] [get_bd_pins UserPicoInstructions/addrb] [get_bd_pins xlslice_0/Dout]
  set_property -dict [ list \
HDL_ATTRIBUTE.MARK_DEBUG {true} \
 ] [get_bd_nets xlslice_0_Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins DSPPicoInstructions/dinb] [get_bd_pins KPPicoInstructions/dinb] [get_bd_pins TDPicoInstructions/dinb] [get_bd_pins UserPicoInstructions/dinb] [get_bd_pins xlslice_1/Dout]
  set_property -dict [ list \
HDL_ATTRIBUTE.MARK_DEBUG {true} \
...
preplace portBus rs232tx -pg 1 -y 940 -defaultsOSRD
...
preplace portBus match_z -pg 1 -y 540 -defaultsOSRD
...
preplace inst DefaultFrequency -pg 1 -lvl 3 -y 310 -defaultsOSRD
preplace inst comparator_1 -pg 1 -lvl 7 -y 1100 -defaultsOSRD
preplace inst xlslice_1 -pg 1 -lvl 7 -y 1790 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 6 -y 1260 -defaultsOSRD
preplace inst LCDctrl -pg 1 -lvl 8 -y 980 -defaultsOSRD
preplace inst rst_clk_wiz_0_49M -pg 1 -lvl 2 -y 1170 -defaultsOSRD
...
preplace inst xlconstant_2 -pg 1 -lvl 3 -y 220 -defaultsOSRD
preplace inst util_vector_logic_0 -pg 1 -lvl 5 -y 1460 -defaultsOSRD
preplace inst xlconstant_3 -pg 1 -lvl 8 -y 1070 -defaultsOSRD
preplace inst one_clock_pulse_0 -pg 1 -lvl 6 -y 1420 -defaultsOSRD
preplace inst xlconstant_4 -pg 1 -lvl 7 -y 1400 -defaultsOSRD
preplace inst n3z_tonetest_0 -pg 1 -lvl 4 -y 390 -defaultsOSRD
preplace inst KPPicoInstructions -pg 1 -lvl 8 -y 1980 -defaultsOSRD
preplace inst xlconstant_5 -pg 1 -lvl 7 -y 1490 -defaultsOSRD
preplace inst UserPicoInstructions -pg 1 -lvl 8 -y 1290 -defaultsOSRD
preplace inst LCDdata -pg 1 -lvl 8 -y 880 -defaultsOSRD
preplace inst TDPicoInstructions -pg 1 -lvl 8 -y 2360 -defaultsOSRD
preplace inst xlconstant_6 -pg 1 -lvl 6 -y 1110 -defaultsOSRD
preplace inst xlconstant_7 -pg 1 -lvl 6 -y 1900 -defaultsOSRD
preplace inst DSPPicoInstructions -pg 1 -lvl 8 -y 1620 -defaultsOSRD
...
preplace inst axi_mem_intercon -pg 1 -lvl 3 -y 670 -defaultsOSRD
preplace inst axi_fifo_mm_s_1 -pg 1 -lvl 4 -y 990 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 2 -y 910 -defaultsOSRD
preplace netloc xlslice_2_Dout 1 6 1 2210
preplace netloc xlconstant_4_dout 1 7 1 2440
preplace netloc n3z_tonetest_0_ledb 1 4 5 NJ 470 NJ 470 NJ 470 NJ 470 NJ
preplace netloc n3z_tonetest_0_srd_bt 1 4 5 NJ 620 NJ 620 NJ 620 NJ 620 NJ
preplace netloc n3z_tonetest_0_kppicoaddress 1 4 4 NJ 700 NJ 700 NJ 700 2520
preplace netloc n3z_tonetest_0_pl2ps_tvalid 1 3 2 1170 1110 1660
preplace netloc axi_mem_intercon_M01_AXI 1 3 1 1060
preplace netloc util_vector_logic_0_Res 1 5 1 1990
preplace netloc n3z_tonetest_0_ps2pl_tready 1 3 2 1120 1120 1630
preplace netloc n3z_tonetest_0_adc_gain 1 4 5 NJ 240 NJ 240 NJ 240 NJ 240 NJ
preplace netloc touchselect_1 1 0 4 NJ 450 NJ 450 NJ 450 NJ
preplace netloc sdob_1 1 0 4 NJ 380 NJ 380 NJ 380 NJ
preplace netloc processing_system7_0_FIXED_IO 1 2 7 NJ 830 NJ 830 NJ 830 NJ 830 NJ 830 NJ 830 NJ
preplace netloc UserPicoInstructions_douta 1 3 5 1140 1170 NJ 1170 NJ 1170 NJ 1170 NJ
preplace netloc n3z_tonetest_0_adc_cal 1 4 5 NJ 220 NJ 220 NJ 220 NJ 220 NJ
preplace netloc n3z_tonetest_0_ledg 1 4 5 NJ 450 NJ 450 NJ 450 NJ 450 NJ
preplace netloc n3z_tonetest_0_classd_lina 1 4 5 NJ 320 NJ 320 NJ 320 NJ 320 NJ
preplace netloc n3z_tonetest_0_classd_linb 1 4 5 NJ 340 NJ 340 NJ 340 NJ 340 NJ
preplace netloc xlconstant_0_dout1 1 6 1 NJ
preplace netloc n3z_tonetest_0_rst_bb 1 8 1 NJ
preplace netloc rst_clk_wiz_0_49M_interconnect_aresetn 1 2 1 700
preplace netloc n3z_tonetest_0_conv 1 4 5 NJ 260 NJ 260 NJ 260 NJ 260 NJ
preplace netloc n3z_tonetest_0_classd_hina 1 4 5 NJ 280 NJ 280 NJ 280 NJ 280 NJ
preplace netloc comparator_0_dout 1 7 1 2470
preplace netloc rst_clk_wiz_0_49M_peripheral_aresetn 1 2 2 730 850 1070
preplace netloc n3z_tonetest_0_classd_hinb 1 4 5 NJ 300 NJ 300 NJ 300 NJ 300 NJ
preplace netloc n3z_tonetest_0_tx_low 1 4 5 NJ 660 NJ 660 NJ 660 NJ 660 NJ
preplace netloc DSPPicoInstructions1_douta 1 3 5 1090 1950 NJ 1950 NJ 1950 NJ 1950 NJ
preplace netloc n3z_tonetest_0_dsppicoaddress 1 4 4 NJ 680 NJ 680 NJ 680 2560
preplace netloc xlconstant_5_dout 1 7 1 2540
preplace netloc xlconstant_1_dout 1 4 1 1630
preplace netloc n3z_tonetest_0_ledr 1 4 5 NJ 480 NJ 480 NJ 480 NJ 480 NJ
preplace netloc n3z_tonetest_0_psuclk 1 4 5 NJ 520 NJ 520 NJ 520 NJ 520 NJ
preplace netloc std_bt_1 1 0 4 NJ 390 NJ 390 NJ 390 NJ
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 3 -20 1070 NJ 1080 640
preplace netloc sdoa_1 1 0 4 NJ 370 NJ 370 NJ 370 NJ
preplace netloc xlslice_1_Dout 1 7 1 2530
preplace netloc n3z_tonetest_0_sclk_bt 1 4 5 NJ 580 NJ 580 NJ 580 NJ 580 NJ
preplace netloc n3z_tonetest_0_userpicoaddress 1 4 4 NJ 760 NJ 760 NJ 760 2550
preplace netloc xlslice_0_Dout 1 7 1 2550
preplace netloc rs232rx_1 1 2 1 670
preplace netloc n3z_tonetest_0_stream_tvalid 1 3 2 1160 1190 1670
preplace netloc one_clock_pulse_0_pulse 1 3 4 1080 1550 NJ 1550 NJ 1550 2190
preplace netloc touchon_1 1 0 4 NJ 430 NJ 430 NJ 430 NJ
preplace netloc axi_fifo_mm_s_1_axi_str_txd_tvalid 1 3 2 1150 850 1640
preplace netloc strobe 1 4 1 N
preplace netloc processing_system7_0_UART0_TX 1 2 7 NJ 1140 NJ 1140 NJ 930 NJ 930 NJ 930 NJ 930 NJ
preplace netloc xlconstant_2_dout 1 3 1 1080
preplace netloc axi_fifo_mm_s_0_axi_str_txd_tdata 1 4 3 N 1270 1980 1310 2200
preplace netloc comparator_1_dout 1 7 1 2510
preplace netloc n3z_tonetest_0_sfs_bt 1 4 5 NJ 600 NJ 600 NJ 600 NJ 600 NJ
preplace netloc n3z_tonetest_0_pl2ps_tlast 1 3 2 1170 820 1630
preplace netloc DSPPicoInstructions_douta 1 3 5 1110 1540 NJ 1540 NJ 1540 NJ 1540 NJ
preplace netloc tdpicoaddress 1 4 4 NJ 720 NJ 720 NJ 720 2480
preplace netloc n3z_tonetest_0_pwmaudio 1 4 5 NJ 540 NJ 540 NJ 540 NJ 540 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 -50 1050 NJ 1070 650
preplace netloc datacounter 1 4 1 N
preplace netloc touchup_1 1 0 4 NJ 470 NJ 470 NJ 470 NJ
preplace netloc axi_fifo_mm_s_0_axi_str_rxd_tready 1 3 2 1170 1520 1690
preplace netloc UserPicoInstructions1_douta 1 3 5 1100 2310 NJ 2310 NJ 2310 NJ 2310 NJ
preplace netloc rs232_from_bt_1 1 2 1 660
preplace netloc clk_wiz_0_locked 1 1 1 220
preplace netloc touchdown_1 1 0 4 NJ 410 NJ 410 NJ 410 NJ
preplace netloc n3z_tonetest_0_lcdcontrast 1 4 5 NJ 400 NJ 400 NJ 400 NJ 400 NJ
preplace netloc xlconstant_6_dout 1 6 1 NJ
preplace netloc n3z_tonetest_0_stream_tlast 1 3 2 1150 1150 1650
preplace netloc comparator_2_dout 1 7 1 2460
preplace netloc axi_fifo_mm_s_1_axi_str_txd_tdata 1 3 2 1130 870 1630
preplace netloc LCDdata_Dout 1 8 1 NJ
preplace netloc n3z_tonetest_0_keepon 1 4 5 NJ 380 NJ 380 NJ 380 NJ 380 NJ
preplace netloc DefaultFrequency_dout 1 3 1 NJ
preplace netloc axi_mem_intercon_M02_AXI 1 3 1 1060
preplace netloc clk_wiz_0_clk_out1 1 1 7 200 750 690 510 1040 1530 NJ 1520 NJ 1350 NJ 1350 2490
preplace netloc DefaultFrequency1_dout 1 1 1 190
preplace netloc processing_system7_0_M_AXI_GP0 1 2 1 680
preplace netloc LCDctrl_Dout 1 8 1 NJ
preplace netloc xlconstant_0_dout 1 6 1 NJ
preplace netloc axi_fifo_mm_s_0_axi_str_txd_tvalid 1 4 4 NJ 1340 NJ 1340 NJ 1340 2450
preplace netloc axi_mem_intercon_M00_AXI 1 3 1 1050
preplace netloc processing_system7_0_UART1_TX 1 2 7 NJ 940 NJ 1160 NJ 1160 NJ 1160 NJ 1160 NJ 1120 NJ
preplace netloc processing_system7_0_GPIO_O 1 2 6 NJ 840 NJ 840 NJ 840 NJ 840 NJ 840 2540
preplace netloc n3z_tonetest_0_sck 1 4 5 NJ 560 NJ 560 NJ 560 NJ 560 NJ
preplace netloc comparator_3_dout 1 7 1 2420
preplace netloc n3z_tonetest_0_match_z 1 4 5 NJ 500 NJ 500 NJ 500 NJ 500 NJ
preplace netloc n3z_tonetest_0_pl2ps_tdata 1 3 2 1160 810 1640
preplace netloc axi_fifo_mm_s_1_axi_str_rxd_tready 1 3 2 1160 1130 1680
preplace netloc n3z_tonetest_0_stream_tdata 1 3 2 1170 1180 1700
preplace netloc xlconstant_6_dout1 1 6 1 NJ
preplace netloc ptt_1 1 0 4 NJ 360 NJ 360 NJ 360 NJ
levelinfo -pg 1 -90 110 450 880 1400 1860 2090 2320 2670 2900 -top -30 -bot 2720
",
   }
{
   da_axi4_cnt: "3",
