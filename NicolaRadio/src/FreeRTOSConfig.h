...
#define configMINIMAL_STACK_SIZE				( ( unsigned short ) 256 ) /* was 256 Large in case configUSE_TASK_FPU_SUPPORT is 2 in which case all tasks have an FPU context. */
//#define configTOTAL_HEAP_SIZE					( 90 * 1024 )
#define configTOTAL_HEAP_SIZE					( 30 * 1024 )   // 40 - 11 Sept 2016 Pete 20 June 2016
...
//#define configGENERATE_RUN_TIME_STATS 1 pete
